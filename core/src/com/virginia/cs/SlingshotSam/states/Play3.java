...
public class Play3 extends GameState {
    ...
    public Play3(GameStateManager gsm) {
        ...
        this.world.setContactListener(new ContactListener() {
            public void beginContact(Contact c) {
                ...
                if (fb.getUserData().equals("foot") && fa.getUserData().equals("ground")) {
                    ...
                    Play3.this.sam.respawn_y = (float) (Play3.this.sam.getPosition().y + .1);
        ...
        objects.add(new GameObject("building1.png",1f,1.2f,.1f,.05f,1.0f,BodyType.StaticBody, "ground", this.world, .05f,-60.0f,-490.0f));
